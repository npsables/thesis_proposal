...
\begin{tabular}{| m{2cm} | m{7cm} | m{1.5cm} | m{1.5cm} | m{1.5cm} | m{1.5cm} |}
    \hline
    ID & Description & Test Data & Expected Result & Actual Result & Pass/Fail                                            \\ \hline
    SOL-01 & Generate a valid mnemonic code contains 12 or 24 words.  & N$\backslash$A & Generate successfully & As expected & Pass \\ \hline
    SOL-02 & Generate a valid mnemonic code contains 12 or 24 words.  &   \\ \hline
