...
\label{item:game_theory}
	...
	Proof-of-work aims to protect the integrity of the ledger by making it hard to modify "old" entries, as changing a block would also require changing all subsequent (later) blocks.

\item Communication Network	
	\begin{quote} 
		Bitcoin blockchain network is peer-to-peer. 
	\end{quote}
\end{itemize}
