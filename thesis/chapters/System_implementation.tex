...
\begin{framed}
\hspace*{13mm}    curl - - request POST \\
\hspace*{13mm}        - - url http://localhost:8080/pushaddress \\
\hspace*{13mm}        - - header 'Content-Type: application/json' \\
\hspace*{13mm}        - - data '\{ \\
\hspace*{27mm}                "address": "test",  \\
\hspace*{40mm}                "chain": "60", \\
\hspace*{40mm}                "purpose": "business1", \\
\hspace*{40mm}                "child\_address": " 0x88d696674a104489f..." \\
\hspace*{27mm}              \} \\
\end{framed}
...
\begin{framed}
\hspace*{13mm}    curl - - request POST \\
\hspace*{13mm}        - - url http://localhost:8080/deleteaddress \\
\hspace*{13mm}        - - header 'Content-Type: application/json' \\
\hspace*{13mm}        - - data '\{ \\
\hspace*{27mm}                "address": "test",  \\
\hspace*{40mm}                "chain": "60", \\
